...
class themeServiceProvider extends ServiceProvider {
    ...
    public function register(){
        ...
        $this->app->singleton('view.finder', function($app) {
            return new \Laraone\Themes\themeViewFinder(
                $app['files'],
	...
	public function boot(){
        ...
        if ($this->app->runningInConsole()) {
            $this->commands([
                \Laraone\Themes\Commands\listThemes::class,
                \Laraone\Themes\Commands\createTheme::class,
                \Laraone\Themes\Commands\removeTheme::class,
                \Laraone\Themes\Commands\createPackage::class,
                \Laraone\Themes\Commands\installPackage::class,
                \Laraone\Themes\Commands\refreshCache::class,
            ]);
        }
